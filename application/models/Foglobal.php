<?php
	...
	class Foglobal extends CI_Model {
	    ...
	    public function IDtoDay($id) {
	      	$data = ["Monday" => "Senin", "Tuesday" => "Selasa", "Wednesday" => "Rabu", "Thursday" => "Kamis", "Friday" => "Jumat", "Saturday" => "Sabtu", "Sunday" => "Minggu"];
	      	return (array_key_exists($id, $data)) ? $data[$id]: "Haru tidak valid";
	    }
