                                ...
                                <div class="wow fadeIn">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active" style="background-image: url('<?php echo base_url("/assets/images/slider1.svg") ?>');">
                                                <div class="carousel-caption">
                                                    <div class="contect-header-text p-3 text-left">
                                                        <h1 class="mt-1 bold" style="color: black;">Semua Orang Bisa<br>Berinvestasi Sekarang</h1>
                                                        <p class="mt-4" style="color: black;">Kamu dapat berinvestasi dari berbagai<br>aspek aset dengan skema crowdfunding<br>mulai dari ratusan ribu</p>
                                                        <a class="btn btn-primary mt-4 bold" href="<?php echo base_url("properti.html"); ?>">Lihat Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item" style="background-image: url('<?php echo base_url("/assets/images/slider2.svg") ?>');">
                                                <div class="carousel-caption">
                                                    <div class="contect-header-text p-3 text-left">
                                                        <!-- <h1 class="mt-1 bold" style="color: black;">&nbsp;</h1> -->
                                                        <p class="mt-4" style="color: black;">Obsido merupakan solusi dalam<br>mengembangkan aset properti dan<br>bisnis dengan izin legalitas resmi</p>
                                                        <a class="btn btn-primary mt-4 bold" href="<?php echo base_url("properti.html"); ?>">Lihat Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item" style="background-image: url('<?php echo base_url("/assets/images/slider3.svg") ?>');">
                                                <div class="carousel-caption">
                                                    <div class="contect-header-text p-3 text-right">
                                                        <h1 class="mt-1 bold" style="color: black;">Lebih dari sekedar<br>Investasi</h1>
                                                        <p class="mt-4" style="color: black;">Investasi, Simpan, Perencanaan aset<br>dan bisnis. Anda dapat melakukan<br>semuanya di Obsido</p>
                                                        <a class="btn btn-primary mt-4 bold" href="<?php echo base_url("properti.html"); ?>">Lihat Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item" style="background-image: url('<?php echo base_url("/assets/images/slider4.svg") ?>');">
                                                <div class="carousel-caption">
                                                    <div class="contect-header-text p-3 text-right">
                                                        <h1 class="mt-1 bold" style="color: black;">Alternatif Pendanaan<br>Aset bisnis terjangkau</h1>
                                                        <p class="mt-4" style="color: black;">Obsido Dapat Mengelola Proyek<br>Pendanaan Aset Dasar Hingga<br>Bernilai Tinggi</p>
                                                        <a class="btn btn-primary mt-4 bold" href="<?php echo base_url("properti.html"); ?>">Lihat Selengkapnya</a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="row mt-3 mb-2">
                                                            ...
                                                            <div class="col-6 pr-0 text-left bold text-primary font-default font-custom-14">
                                                                ...
                                                                Harga Per Lembar<br><?php echo $this->foglobal->rupiah($item->harga_per_lembar, true) ?>
                                                            </div>
                                                            <div class="col-6 pl-0 text-left bold text-primary font-default font-custom-14">
                                                                ROI<br><?php echo $this->foglobal->persen($item->roi) ?>%<br><br>
                                                                Total Saham<br><?php echo $this->foglobal->rupiah($item->total_per_lembar) ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
