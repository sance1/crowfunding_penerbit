...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Obsido - Perbarui Proyek</title>
        ...
        <link rel="stylesheet" href="<?php echo base_url("assets/plugins/cropperjs-master/docs/css/cropper.css"); ?>">
    ...
    <body>
                                    ...
                                    <div class="col-12 p-3 mt-3 mb-2">
                                        <form id="msform" class="font-default form-properti" method="POST" action="/properti/ajax_properti">
                                            <div class="row mb-5 text-center">
                                                <div class="col-sm-3"><a style="font-size: 29px; font-weight: 600;" <?php if($properti->status_projek != "Selesai"){ ?>class="tab-header tab-detail active" <?php } ?> >Detail</a></div>
                                                <div class="col-sm-3"><a style="font-size: 29px; font-weight: 600;" <?php if($properti->status_projek != "Selesai"){ ?>class="tab-header tab-deskripsi" <?php } ?> >Deskripsi</a></div>
                                                <div class="col-sm-3"><a style="font-size: 29px; font-weight: 600;" <?php if($properti->status_projek != "Selesai"){ ?>class="tab-header tab-dokumen" <?php } ?> >Dokumen</a></div>
                                                <div class="col-sm-3"><a style="font-size: 29px; font-weight: 600;" class="tab-header tab-grafik-progress">Progres</a></div>
                                            </div>
                                                ...
                                                <div class="row ml-0 mr-0">
                                                    <div class="col-12 mb-3 pl-4 pr-4 div-overflow-image-judul">
                                                        <div class="row row-image-judul">
                                                            <div class="div-image-judul div-image-tambah d-inline m-2 text-primary text-center" style="font-size: 50px; padding-top: 40px; cursor: pointer;"><i class="fa fa-plus"></i></div>
                                                            <?php 
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control jumlah-dana text-right" placeholder="Jumlah Dana" maxlength="19" name="form[jumlah_dana]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->jumlah_dana); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Harga Saham</label>
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control harga-per-lembar text-right" placeholder="Harga Saham" maxlength="19" name="form[harga_per_lembar]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->harga_per_lembar); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Total Saham</label>
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control total-per-lembar text-right" placeholder="Total Saham" maxlength="19" name="form[total_per_lembar]" onkeypress="return validatedata(event);" value="<?php echo $this->foglobal->rupiah($properti->total_per_lembar); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Periode Dividen</label>
                                                            <select <?php if($properti->status_projek == "Tersedia"){ echo "disabled"; } ?> class="form-control select" name="form[dividen_period]">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select <?php if($properti->status_projek == "Tersedia"){ echo "disabled"; } ?> class="form-control select" name="form[tipe_aset]">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="number" class="form-control" placeholder="Persentase Saham" name="form[lepas_saham]" value="<?php echo $properti->lepas_saham; ?>">
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control" placeholder="Nama Projek" maxlength="100" name="form[nama]" value="<?php echo $properti->nama; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Latitude</label>
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control" placeholder="Latitude" maxlength="25" name="form[latitude]" value="<?php echo explode(", ",$properti->latitude_longitude)[0]; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Longitude</label>
                                                            <input <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control" placeholder="Longitude" maxlength="25" name="form[longitude]" value="<?php echo explode(", ",$properti->latitude_longitude)[1]; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-control-label text-dark">Alamat</label>
                                                            <textarea <?php if($properti->status_projek == "Tersedia"){ echo "readonly"; } ?> type="text" class="form-control input-uppercase" placeholder="Alamat" maxlength="150" name="form[alamat]" style="height: 60px;"><?php echo $properti->alamat; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <div class="mt-repeater-deskripsi mt-repeater-group">
                                                                <table class="table table-striped table-bordered">
                                                                    <thead class="thead-light">
                                                                        <tr>
                                                                            <th class="bold text-primary">Deskripsi</th>
                                                                ...
                                                                <a data-repeater-create role="button" class="btn btn-primary btnTambahDeskripsi float-left text-light"><i class="fa fa-plus"></i> Tambah Deskripsi</a>
                                                                <br>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row ml-0 mr-0">
                                                    <div class="col-lg-12">
                                                        <table class="table table-striped table-dokumen">
                                                            <thead>
                                                                <tr>
                                                                    <th class="bold text-primary">Nama Berkas</th>
                                                                    <th class="bold text-primary">Keterangan</th>
                                                                    <th class="bold text-primary" style="width: 200px;">Tanggal Unggah</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php 
                                                                    foreach ($dokumen as $item) {
                                                                        ?>
                                                                            <tr>
                                                                                <td>
                                                                                    <a class="bold text-primary" onclick="window.open('<?php echo $this->config->item("cdn_url"); ?>/file_upload/<?php echo $item->file; ?>', '', 'width=800,height=400');"><?php echo $item->nama; ?></a>&nbsp;&nbsp;&nbsp;<a class="bold text-danger btn-delete-dokumen"><i class="fa fa-times"></i></a>
                                                                                </td>
                                                                                <td>
                                            ...
                                            <div class="card px-0 pt-4 pb-4 pb-0 mt-3 mb-3 shadow div-panel div-panel-grafik-progress d-none">
                                                <div class="row ml-0 mr-0">
                                                        ...
                                                        <table class="table table-striped table-grafik-progress">
                                                            <thead>
                                                                <tr class="bulan-progress">
                                                                    <th class="bold text-primary" style="min-width: 300px;" colspan="2">Keterangan</th>
                                                                    <th class="bold text-primary text-center" style="width: 140px; min-width: 140px;">Mulai</th>
                                                                    <th class="bold text-primary text-center" style="width: 140px; min-width: 140px;">Selesai</th>
                                                                    <th class="bold text-primary text-center" style="width: 100px; min-width: 100px;">Durasi</th>
                                                                    <th class="bold text-primary text-center tahun-progress" style="width: 200px; min-width: 200px;">Progres</th>
                                                                </tr>
                                                                <!-- <tr class="bulan-progress">
                                                                    <th class="bold text-primary" style="width: 300px; min-width: 300px;" colspan="2" rowspan="2">Keterangan</th>
                                                                    <th class="bold text-primary text-center" style="width: 140px; min-width: 140px;" rowspan="2">Mulai</th>
                                                                    <th class="bold text-primary text-center" style="width: 140px; min-width: 140px;" rowspan="2">Selesai</th>
                                                                    <th class="bold text-primary text-center" style="width: 100px; min-width: 100px;" rowspan="2">Durasi</th>
                                                                    <th class="bold text-primary text-center tahun-progress" style="width: 100px; min-width: 100px;" rowspan="2">Progres</th>
                                                                    <th class="bold text-primary text-center tahun-progress-tambahan" colspan="4"><?php echo date("Y") ?></th>
                                                                </tr> -->
                                                                <!-- <tr>
                                                                    <td class="bold text-primary text-center bulan-progress-tambahan" style="width: 100px; min-width: 100px;">Jan-Mar</td>
                                                                    <td class="bold text-primary text-center bulan-progress-tambahan" style="width: 100px; min-width: 100px;">Apr-Jun</td>
                                                                    <td class="bold text-primary text-center bulan-progress-tambahan" style="width: 100px; min-width: 100px;">Jul-Sep</td>
                                                                    <td class="bold text-primary text-center bulan-progress-tambahan" style="width: 100px; min-width: 100px;">Oct-Dec</td>
                                                                </tr> -->
                                                            </thead>
                                                            <tbody>
                                                                <?php 
                                                                    foreach ($grafik as $item) {
                                                                        $foto_data_url = "";
                                                                        if($item->foto != ""){
                                                                            $foto_data_url = "<a class='bold text-primary' onclick='OpenImage(".'"'.$this->config->item("cdn_url")."/file_upload/".$item->foto.'"'.");'><i style='font-size: 30px;' class='fa fa-image'></i></a>";
                                                                        }
                                                                        ...
                                                                        ?>
                                                                            <tr>
                                                                                ...
                                                                                <?php } else { ?>
                                                                                    <td><a class="bold text-primary edit-keterangan"><?php echo $item->keterangan; ?></a>&nbsp;&nbsp;&nbsp;<a class="bold text-danger btn-delete-grafik-progress"><i class="fa fa-times"></i></a></td>
                                                                                <?php } ?>
                                                    ...
                                                    <a class="btn btn-primary text-white btn-modal-grafik-progress mt-2 ml-2"><i class="fa fa-plus"></i> Tambah Progres</a>
                                                </div>
                                            </div>
                                            <a class="btn btn-primary text-white ladda-button ladda-button-submit float-right" onclick="SimpanTambahProperti();" data-style="slide-up">Simpan</a>
        ...
        <script type="text/javascript" src="<?php echo base_url("assets/plugins/cropperjs-master/docs/js/cropper.js"); ?>"></script>
        ...
        <script>
            ...
            <?php if($properti->status_projek == "Tersedia"){ ?>
            setTimeout(function(){
            ...
            function initMap() {
                ...
                <?php if($properti->status_projek == "Menunggu Konfirmasi"){ ?>
            ...
            function CheckTableProgress(){
                ...
                $(".table-grafik-progress tbody tr").each(function(index) {
                    ...
                    if(start_year > parseInt(moment($(this).find(".progress-tgl-mulai").val()).format("YYYY"))){
                        start_year = parseInt(moment($(this).find(".progress-tgl-mulai").val()).format("YYYY"));
                    }
                    if(end_year < parseInt(moment($(this).find(".progress-tgl-selesai").val()).format("YYYY"))){
                        end_year = parseInt(moment($(this).find(".progress-tgl-selesai").val()).format("YYYY"));
                    }
                });
                var total_tahun = 0;
                for(end_year; end_year >= start_year ; end_year--){
                    $(".tahun-progress").after("<th class='bold text-primary text-center tahun-progress-tambahan' colspan='4'>"+end_year+"</th>");
                    $(".bulan-progress").after("<td class='bold text-primary text-center bulan-progress-tambahan' style='width: 100px; min-width: 100px;'>Jan-Mar</td><td class='bold text-primary text-center bulan-progress-tambahan' style='width: 100px; min-width: 100px;'>Apr-Jun</td><td class='bold text-primary text-center bulan-progress-tambahan' style='width: 100px; min-width: 100px;'>Jul-Sep</td><td class='bold text-primary text-center bulan-progress-tambahan' style='width: 100px; min-width: 100px;'>Oct-Dec</td>");
                    total_tahun++;
                }
                console.log(total_tahun);
                $(properti_grafik_progress_cek_tahun).each(function(index, item) {
                    var total_bulan = (Math.ceil(moment(item.tgl_selesai).diff(moment(item.tgl_mulai), "months", true))-1);
                    ...
                    var html_bulan_tambahan = "";
                    var total_colspan = 1;
                    var found_colspan = false;
                    var end_colspan = false;
                    for(var x = 0; x < total_tahun ; x++){
                        if((start_year+x) == parseInt(moment(item.tgl_mulai).format("YYYY"))){
                            // q1
                            if(moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("01") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("02") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("03")){
                                found_colspan = true;
                                html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;' colspan-data><div style='background: #28a745; height: 21px; width: "+item.progress+"%; display: inline-block;'></div><div style='background: #0084ff; height: 21px; width: "+(100-item.progress)+"%; display: inline-block;'></div></td>";
                                if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                    if(moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("01") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("02") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("03")){
                                        end_colspan = true;
                                        total_colspan++;
                                    } else {
                                        total_colspan++;
                                ...
                                if(found_colspan == true){
                                    if(end_colspan == true){
                                        html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;'></td>";
                                    } else {
                                        if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                            if(moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("01") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("02") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("03")){
                                                end_colspan = true;
                            ...
                            // q2
                            if(moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("04") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("05") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("06")){
                                found_colspan = true;
                                html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;' colspan-data><div style='background: #28a745; height: 21px; width: "+item.progress+"%; display: inline-block;'></div><div style='background: #0084ff; height: 21px; width: "+(100-item.progress)+"%; display: inline-block;'></div></td>";
                                if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                    if(moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("04") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("05") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("06")){
                                        end_colspan = true;
                                        total_colspan++;
                                    } else {
                                        total_colspan++;
                            ...
                            // q3
                            if(moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("07") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("08") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("09")){
                                found_colspan = true;
                                html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;' colspan-data><div style='background: #28a745; height: 21px; width: "+item.progress+"%; display: inline-block;'></div><div style='background: #0084ff; height: 21px; width: "+(100-item.progress)+"%; display: inline-block;'></div></td>";
                                if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                    if(moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("07") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("08") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("09")){
                                        end_colspan = true;
                                        total_colspan++;
                                    } else {
                                        total_colspan++;
                            ...
                            // q4
                            if(moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("10") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("11") || moment(item.tgl_mulai).format("MM") == moment(item.tgl_mulai).format("12")){
                                found_colspan = true;
                                html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;' colspan-data><div style='background: #28a745; height: 21px; width: "+item.progress+"%; display: inline-block;'></div><div style='background: #0084ff; height: 21px; width: "+(100-item.progress)+"%; display: inline-block;'></div></td>";
                                if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                    if(moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("10") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("11") || moment(item.tgl_selesai).format("MM") == moment(item.tgl_selesai).format("12")){
                                        end_colspan = true;
                                        total_colspan++;
                                    } else {
                                        total_colspan++;
                            ...
                            if((start_year+x) == parseInt(moment(item.tgl_selesai).format("YYYY"))){
                                ...
                                if(found_colspan == true){
                                    if(end_colspan == true){
                                        html_bulan_tambahan += "<td style='padding: 7px 0px 7px 0px !important;'></td><td style='padding: 7px 0px 7px 0px !important;'></td><td style='padding: 7px 0px 7px 0px !important;'></td><td style='padding: 7px 0px 7px 0px !important;'></td>";
                                    } else {
                                        total_colspan++;
                                        total_colspan++;
                                        total_colspan++;
                    ...
                    console.log("total colspan index ke "+index+" = "+total_colspan);
                    html_bulan_tambahan = html_bulan_tambahan.replace(/colspan-data/g, "colspan='"+total_colspan+"'", html_bulan_tambahan);
                    html_grafik_progress_cek_tahun += "<tr><td style='width:10px;'>"+foto_data_url+"</td><td><a class='bold text-primary edit-keterangan'>"+item.keterangan+"</a>&nbsp;&nbsp;&nbsp;<a class='bold text-danger btn-delete-grafik-progress'><i class='fa fa-times'></i></a></td><td class='text-center'>"+moment(item.tgl_mulai).format("DD MMM YYYY")+"</td><td class='text-center'>"+moment(item.tgl_selesai).format("DD MMM YYYY")+"</td><td class='text-center'>"+(parseInt(moment(item.tgl_selesai).diff(moment(item.tgl_mulai), "days"))+1)+"</td><td class='text-center'>"+item.progress+"%<input type='hidden' class='progress-foto' value='"+item.foto+"'><input type='hidden' class='progress-keterangan' value='"+item.keterangan+"'><input type='hidden' class='progress-tgl-mulai' value='"+item.tgl_mulai+"'><input type='hidden' class='progress-tgl-selesai' value='"+item.tgl_selesai+"'><input type='hidden' class='progress-progress' value='"+item.progress+"'></td>"+html_bulan_tambahan+"</tr>";
                });
                $(".table-grafik-progress tbody").html(html_grafik_progress_cek_tahun);*/
            }
        ...
        <?php if($properti->status_projek == "Selesai"){ ?>
            <script>
                $(".tab-grafik-progress").click();
            </script>
        <?php } ?>
    </body>
</html>