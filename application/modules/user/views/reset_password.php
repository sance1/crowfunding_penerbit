                            ...
                            <div class="col-lg-6">
                                <div class="card m-b-30" style="border: none;">
                                    ...
                                    <div class="col-12 pl-5 pr-5 pb-5">
                                        <form id="FrmPassword" class="subscribe-form form-reset-password" role="form" method="POST" action="/penerbit/ajax_penerbit" style="visibility: visible;" autocomplete="off">
