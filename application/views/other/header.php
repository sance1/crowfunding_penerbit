<?php 
    ...
    if($this->session->userdata("user")->photo == ""){
        $photo_profil = base_url("/assets/images/no-image.jpg");
    } else {
        $photo_profil = $this->config->item("cdn_url")."/".$this->session->userdata("user")->photo;
    }
?>
    ...
    <div class="header-container">
        <div class="header-left">
            ...
            <div class="header-logo">
                <a href="">
                    <img class="logo" src="<?php echo base_url("assets/media/image/logo.png"); ?>" alt="logo" />
                </a>
            </div>
        </div>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            ...
                            <div class="dropdown-scroll">
                                <div class="list-group list-group-flush">
                                    <a href="#" class="px-4 py-3 list-group-item d-flex">
                                        <div class="flex-shrink-0">
                                            <figure class="avatar mr-3">
                                                <img class="rounded" src="<?php echo base_url("assets/media/image/products/product6.png"); ?>" alt="Canon 4000D 18-55 MM" />
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 line-height-20 d-flex justify-content-between">
                                    ...
                                    <a href="#" class="px-4 py-3 list-group-item d-flex">
                                        <div class="flex-shrink-0">
                                            <figure class="avatar mr-3">
                                                <img class="rounded" src="<?php echo base_url("assets/media/image/products/product3.png"); ?>" alt="pineapple" />
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 line-height-20 d-flex justify-content-between">
                                    ...
                                    <a href="#" class="px-4 py-3 list-group-item d-flex">
                                        <div class="flex-shrink-0">
                                            <figure class="avatar mr-3">
                                                <img src="<?php echo base_url("assets/media/image/products/product7.png"); ?>" class="rounded" alt="pineapple" />
                                            </figure>
                                        </div>
                                        <div class="flex-grow-1">
                                            <p class="mb-0 line-height-20 d-flex justify-content-between">
                            ...
                            <div class="px-4 py-3 border-top text-right small">
                                ...
                                <button class="btn btn-primary btn-block mt-2">Order and Payment <i class="ti-arrow-right ml-2"></i></button>
                            </div>
                        </div>
                    </li> -->
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" title="User menu" data-toggle="dropdown">
                            <figure class="avatar avatar-sm">
                                <img src="<?php echo $photo_profil; ?>" class="rounded-circle" alt="avatar" />
                            </figure>
                            <span class="ml-2 d-sm-inline d-none"><?php echo $userlogin->name ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="text-center py-4">
                                <figure class="avatar avatar-lg mb-3 border-0">
                                    <img src="<?php echo $photo_profil; ?>" class="rounded-circle" alt="image" />
                                </figure>
                                <h5 class="text-center"><?php echo $userlogin->name ?></h5>
                                <!-- <a href="#" class="btn btn-outline-light btn-rounded">Manage Your Account</a> -->
                            </div>
                            <div class="list-group">
                                <a href="<?php echo base_url("user/edit_profil.html") ?>" class="list-group-item">Edit Profile</a>
                                <a href="<?php echo base_url("login/logout.html") ?>" class="list-group-item text-danger">Sign Out!</a>
                            </div>
                        </div>
                    </li>
                </ul>
